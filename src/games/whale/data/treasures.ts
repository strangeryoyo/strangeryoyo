...
export const TREASURES: TreasureData[] = [
  ...
  { col: 5, row: 4, room: 0, type: TreasureType.Pearl, collected: false },
  { col: 13, row: 8, room: 0, type: TreasureType.Pearl, collected: false },
  { col: 8, row: 3, room: 1, type: TreasureType.Pearl, collected: false },
  { col: 11, row: 10, room: 1, type: TreasureType.Pearl, collected: false },
  { col: 4, row: 6, room: 2, type: TreasureType.Pearl, collected: false },
  { col: 5, row: 4, room: 4, type: TreasureType.Pearl, collected: false },
  ...
  { col: 14, row: 8, room: 6, type: TreasureType.Gem, collected: false },
